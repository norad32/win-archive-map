export function updateNeighbourhoodOptions(selectElement, districtToNeighbourhoods, selectedDistrict) {
    ...
    selectElement.value = neighbourhoods.includes(previousValue) ? previousValue : "";
}
