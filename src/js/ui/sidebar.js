...
export function createSidebar({ domRefs, dataStore, map }) {
    ...
    function handleDistrictChange(e) {
        ...
        populateStreetOptions(domRefs.streetOptionsEl, dataStore.getDistrictsData(), districtVal);
    ...
    function attachListeners() {
        ...
        if (domRefs.neighbourhoodSelectEl) {
            domRefs.neighbourhoodSelectEl.addEventListener("change", handleNeighbourhoodChange);
        }
    }
...
export function updateNeighbourhoodOpts(selectElement, districtToNeighbourhoods, selectedDistrict) {
    updateNeighbourhoodOptions(selectElement, districtToNeighbourhoods, selectedDistrict);
}